...
export default function PremiumLandingScreen({ navigation }: Props) {
  ...
  const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description, delay }) => {
    return (
      <PremiumCard variant="blur" padding="large" animate delay={delay} style={styles.featureCard}>
        <View style={styles.featureIcon}>
          <LinearGradient
            colors={[premiumTheme.colors.primary[400], premiumTheme.colors.primary[600]]}
            style={styles.featureIconGradient}
          >
            <Ionicons name={icon as any} size={24} color={premiumTheme.colors.text.inverse} />
          </LinearGradient>
        </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient
        colors={[premiumTheme.colors.primary[50], premiumTheme.colors.background.primary]}
        style={styles.gradient}
      >
        {/* Animated background shapes */}
        <Animated.View style={[styles.floatingShape1, shape1Style]}>
          <LinearGradient
            colors={[premiumTheme.colors.primary[200], premiumTheme.colors.primary[400]]}
        ...
        <Animated.View style={[styles.floatingShape2, shape2Style]}>
          <LinearGradient
            colors={[premiumTheme.colors.accent.light, premiumTheme.colors.accent.main]}
            style={styles.shapeGradient}
          />
        </Animated.View>
          ...
          >
            ...
            <Animated.View style={[styles.heroSection, heroStyle]}>
              <View style={styles.logoContainer}>
                <LinearGradient
                  colors={[premiumTheme.colors.primary[500], premiumTheme.colors.primary[700]]}
                  style={styles.logoGradient}
                >
                  <Ionicons name="car-sport" size={48} color={premiumTheme.colors.text.inverse} />
                </LinearGradient>
              </View>
              
              <Text style={styles.appTitle}>Førerkort</Text>
              <Text style={styles.tagline}>Din vei til førerkortet</Text>
            ...
            <View style={styles.actionSection}>
              <PremiumButton
                ...
                size="large"
                fullWidth
                icon={<Ionicons name="play" size={20} color={premiumTheme.colors.text.inverse} />}
              />
              
              <PremiumButton
                title="Se tidligere resultater"
            ...
            <View style={styles.featuresSection}>
              ...
              <View style={styles.featuresGrid}>
                ...
                <FeatureCard
                  ...
                  title="Oppdatert innhold"
                  description="Alltid siste versjon av testen"
                  delay={400}
                />
              </View>
            </View>
            ...
            {/* Motivational Quote */}
            <PremiumCard variant="gradient" padding="large" style={styles.quoteCard}>
...
const createStyles = () => StyleSheet.create({
  ...
  appTitle: {
    fontSize: premiumTheme.typography.fontSize["4xl"],
  ...
  featureCard: {
    width: (width - premiumTheme.spacing.lg * 2 - premiumTheme.spacing.sm * 2) / 2,
  ...
  featureDescription: {
    ...
    color: premiumTheme.colors.text.secondary,
    textAlign: "center",
    lineHeight: premiumTheme.typography.fontSize.sm * premiumTheme.typography.lineHeight.relaxed,
  },
  quoteCard: {
